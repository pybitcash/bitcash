...
# Import BitCash version from the directory above.
...
# further. For a list of options available, see https://shibuya.lepture.com
html_theme_options = {"github_url": "https://github.com/pybitcash/bitcash"}
...
latex_documents = [
    (master_doc, "bitcash.tex", "bitcash Documentation", "Teran McKinney", "manual"),
]
...
man_pages = [(master_doc, "bitcash", "bitcash Documentation", [author], 1)]
