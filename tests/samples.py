...
BITCOIN_CASHADDRESS_REGTEST_COMPRESSED = 'bchreg:qzvsaasdvw6mt9j2rs3gyps673gj86flevt7e3kuu4'
...
CONVERT_BITS_INVALID_DATA_PAYLOAD = [0, 146, 70, 27, 222, 98, 131, 256, 97, 236, 231, 221,
    244, 219, 241, 224, 164, 139, 209, 19, 216]

CONVERT_BITS_NO_PAD_PAYLOAD = [0, 146, 70, 27, 222, 98, 131, 25, 97, 236, 231, 221, 244, 219, 241, 224,
    164, 139, 209, 19, 216]
CONVERT_BITS_NO_PAD_RETURN = [0, 2, 9, 4, 12, 6, 30, 30, 12, 10, 1, 17, 18, 24, 15, 12, 28, 31, 14,
    31, 9, 22, 31, 17, 28, 2, 18, 8, 23, 20, 8, 19, 27]