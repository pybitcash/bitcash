...
class NetworkAPI:
    ...
    GET_TRANSACTIONS_TEST = [BitcoinDotComAPI.get_transactions_testnet,
                             BitcoreAPI.get_transactions_testnet]
    ...
    GET_TX_TEST = [BitcoinDotComAPI.get_transaction_testnet,
                   BitcoreAPI.get_transaction_testnet]
    GET_TX_AMOUNT_TEST = [BitcoinDotComAPI.get_tx_amount_testnet,
                          BitcoreAPI.get_tx_amount_testnet]
